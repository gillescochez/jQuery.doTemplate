$.doTemplate = (function() {
    ...
    var newTemplate = function(config) {
        ...
        template.prototype = (function(config) {
        ...
        $.each(['Data', 'Source', 'Target'], function(i, prop) {
            ...
            (function(prop, proplow) {
                ...
                template.prototype['set' + prop] = function(val) {
                    this[proplow] = val;
                    return this;
                };

                template.prototype['get' + prop] = function() {
                    return this[proplow];
                };
    ...
    return function() {
        ...
        throw '$.doTemplate: invalid request';
    };
