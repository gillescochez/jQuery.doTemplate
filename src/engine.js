...
/*
  ...
  //  }
    ...
    global.doT.template = function(tmpl, c, def) {
        ...
        try {
            return new (c.varname ? Function(c.varname, str) : Function('for(var n in arguments[0])this[n]=arguments[0][n];delete n;' + str));
        } catch (e) {
    ...
    global.doT.compile = function(tmpl, def) {
